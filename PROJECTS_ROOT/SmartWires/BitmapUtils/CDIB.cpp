...
{
	StretchDIBits(hDest,nXDest,nYDest,nDWidth,nDHeight,xSrc,ySrc,nSWidth,nSHeight,m_pBits,(CONST BITMAPINFO * )&m_pInfo->bmiHeader,DIB_RGB_COLORS,SRCCOPY);
}
...
BOOL CDIB::OpenDIB(const CString& csFileName)
{
	return OpenBMP(csFileName);
}
