...
public:
	...
	BOOL& IsWasLclick(){return lIsLClickWas;};
	void SetTitle(LPCTSTR szText);
	void SetFooter(LPCTSTR szText);
	void SetText(LPCTSTR szText);
	void SetTextFont(LPCTSTR szFont,int nSize,int nStyle);
	void SetTextDefaultFont(CFont* myFont);
	...
	void SetBgColor(COLORREF crTextColor);
