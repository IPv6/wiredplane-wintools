...
bool asc_date_file_sort(const CSAFileEntry &a, const CSAFileEntry &b);
...
bool dsc_date_file_sort(const CSAFileEntry &a, const CSAFileEntry &b);
...
bool CSADirRead::SortFiles(int iSortStyle, bool bReverse)
{
	...
	default:
		break;
	case eSortAlpha:
		m_files.sort((bReverse ? dsc_alpha_file_sort : asc_alpha_file_sort));
		break;
	case eSortWriteDate:
		m_files.sort((bReverse ? dsc_date_file_sort : asc_date_file_sort));
		break;
	case eSortSize:
		m_files.sort((bReverse ? dsc_size_file_sort : asc_size_file_sort));
		break;
	}
