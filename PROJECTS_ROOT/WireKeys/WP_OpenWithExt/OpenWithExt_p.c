...
extern const MIDL_SERVER_INFO IWKShellExtender_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IWKShellExtender_ProxyInfo;
...
static const unsigned short IWKShellExtender_FormatStringOffsetTable[] =
    {
    0
    };

static const MIDL_STUBLESS_PROXY_INFO IWKShellExtender_ProxyInfo =
    {
    &Object_StubDesc,
    OpenWithExt__MIDL_ProcFormatString.Format,
    &IWKShellExtender_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IWKShellExtender_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    OpenWithExt__MIDL_ProcFormatString.Format,
...
const CInterfaceProxyVtbl * const _OpenWithExt_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IWKShellExtenderProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _OpenWithExt_StubVtblList[] = 
{
