...
//BEGIN_EVENTSINK_MAP(CWebBrowser2, CWnd)
	//ON_EVENT(CWebBrowser2, 0, DISPID_NEWWINDOW2, OnNewWindow2, VTS_PDISPATCH VTS_PBOOL)
	//ON_EVENT(CWebBrowser2, 0, DISPID_DOCUMENTCOMPLETE, DocumentComplete, VTS_DISPATCH VTS_PVARIANT)
	//ON_EVENT(CWebBrowser2, 0, 271/*DISPID_NAVIGATEERROR*/, NavigateError, VTS_DISPATCH VTS_PVARIANT)
//END_EVENTSINK_MAP()
LRESULT CWebBrowser2::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
	//FLOG1("WBMSG=%X",message);
	return CWnd::WindowProc(message, wParam, lParam);
}

BOOL CWebBrowser2::PreTranslateMessage(MSG* pMsg)
{
	//FLOG1("WBMSG_PT=%X",pMsg->message);
	return CWnd::PreTranslateMessage(pMsg);
}

/////////////////////////////////////////////////////////////////////////////
// CWebBrowser2 properties
void CWebBrowser2::NavigateError(LPDISPATCH* ppDisp, VARIANT* URL,VARIANT* TargetFrameName, VARIANT* StatusCode, BOOL* bCancel)
{
	if(bCancel){
		*bCancel=TRUE;
	}
...
void CWebBrowser2::OnNewWindow2(LPDISPATCH* ppDisp, BOOL* bCancel)
{
	if(bCancel){
		*bCancel=FALSE;
	}
...
void CWebBrowser2::DocumentComplete(LPDISPATCH pDisp, VARIANT* URL)
{
...
void CWebBrowser2::OnPaint()
{
	...
	if(hWatcher==0){
		DWORD dwI=0;
		hWatcher=CreateThread(0,0,WatchPBar,GetSafeHwnd(),0,&dwI);
	}
	...
	CDC* pDC=GetDC();
	//CFont* pOld=pDC->SelectObject(GetParent()->GetFont());
	pDC->SetBkMode(TRANSPARENT);
	//CString sText;
	//GetWindowText(sText);
	//pDC->DrawText(sText,&rtText,DT_CENTER|DT_WORDBREAK);
