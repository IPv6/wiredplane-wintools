...
AppVerName={#APP_NAME}
DefaultDirName={code:WCBase}\Skins\{#APP_NAME}\
DefaultGroupName={#APP_NAME}
;LicenseFile={#APP_NAME}\license.txt
Compression=lzma
SolidCompression=true
OutputDir=\_WPLabs\_Installers\_Installers_NSkins
...
Source: {#APP_NAME}\*; DestDir: {code:WCBase}\Skins\{#APP_NAME}\; Flags: recursesubdirs ignoreversion createallsubdirs uninsrestartdelete
...
begin
    ...
    begin
      ...
      if(MainWnd <> 0) then
       ...
       MsgBox('Installation finished. Check options to configure newly installed component', mbInformation, MB_OK);
       end;
